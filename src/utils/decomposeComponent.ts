...
export default function decomposeComponent(component: { id: any; style: { rotate: number; width: number; height: number; left: number; top: number }; groupStyle: { width?: any; height?: any } }, editorRect: { left: number; top: number }, parentStyle: { rotate: any; width: number; height: number }) {
